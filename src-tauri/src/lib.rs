...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::elicitation_persistence::load_elicitation_persistence,
            commands::elicitation_persistence::persist_elicitation_updates,
            commands::elicitation_persistence::clear_elicitation_persistence,
